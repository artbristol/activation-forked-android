...
class MimeTypeParameterList implements Cloneable {
    ...
    public boolean equals(Object thatObject) {
        ...
        if (!(thatObject instanceof eu.ocathain.awt.datatransfer.MimeTypeParameterList)) {
            return false;
        }
        eu.ocathain.awt.datatransfer.MimeTypeParameterList that = (eu.ocathain.awt.datatransfer.MimeTypeParameterList)thatObject;
     ...
     */
     ...
     public Object clone() {
         eu.ocathain.awt.datatransfer.MimeTypeParameterList newObj = null;
         try {
             newObj = (eu.ocathain.awt.datatransfer.MimeTypeParameterList)super.clone();
