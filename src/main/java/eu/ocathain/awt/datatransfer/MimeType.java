...
import eu.ocathain.awt.datatransfer.MimeTypeParseException;
...
class MimeType implements Externalizable, Cloneable {
     ...
     */
    public MimeType(String rawdata) throws eu.ocathain.awt.datatransfer.MimeTypeParseException {
        parse(rawdata);
    }
     ...
     */
    public MimeType(String primary, String sub) throws eu.ocathain.awt.datatransfer.MimeTypeParseException {
        this(primary, sub, new eu.ocathain.awt.datatransfer.MimeTypeParameterList());
    }
     ...
     */
    public MimeType(String primary, String sub, eu.ocathain.awt.datatransfer.MimeTypeParameterList mtpl) throws
            eu.ocathain.awt.datatransfer.MimeTypeParseException {
        //    check to see if primary is valid
        if(isValidToken(primary)) {
            primaryType = primary.toLowerCase();
        } else {
            throw new eu.ocathain.awt.datatransfer.MimeTypeParseException("Primary type is invalid.");
        }
        ...
        if(isValidToken(sub)) {
            ...
            throw new eu.ocathain.awt.datatransfer.MimeTypeParseException("Sub type is invalid.");
        }

        parameters = (eu.ocathain.awt.datatransfer.MimeTypeParameterList)mtpl.clone();
    }
    ...
    public boolean equals(Object thatObject) {
        if (!(thatObject instanceof eu.ocathain.awt.datatransfer.MimeType)) {
            return false;
        }
        eu.ocathain.awt.datatransfer.MimeType that = (eu.ocathain.awt.datatransfer.MimeType)thatObject;
        boolean isIt =
     ...
     * @throws NullPointerException if <code>rawdata</code> is null
     */
    private void parse(String rawdata) throws eu.ocathain.awt.datatransfer.MimeTypeParseException {
        int slashIndex = rawdata.indexOf('/');
        int semIndex = rawdata.indexOf(';');
        if((slashIndex < 0) && (semIndex < 0)) {
            //    neither character is present, so treat it
            //    as an error
            throw new eu.ocathain.awt.datatransfer.MimeTypeParseException("Unable to find a sub type.");
...
1).trim().toLowerCase();
            parameters = new eu.ocathain.awt.datatransfer.MimeTypeParameterList();
...
semIndex).trim().toLowerCase();
            parameters = new
                    eu.ocathain.awt.datatransfer.MimeTypeParameterList(rawdata.substring(semIndex));
        } else {
     ...
     */
    public eu.ocathain.awt.datatransfer.MimeTypeParameterList getParameters() {
        return (eu.ocathain.awt.datatransfer.MimeTypeParameterList)parameters.clone();
    }
     ...
     *    <code>false</code>
     */
    public boolean match(eu.ocathain.awt.datatransfer.MimeType type) {
        if (type == null)
            return false;
     ...
     */
    public boolean match(String rawdata) throws eu.ocathain.awt.datatransfer.MimeTypeParseException {
        if (rawdata == null)
            return false;
        return match(new eu.ocathain.awt.datatransfer.MimeType(rawdata));
    }
...
ClassNotFoundException {
    ...
    public Object clone() {
        eu.ocathain.awt.datatransfer.MimeType newObj = null;
        try {
            newObj = (eu.ocathain.awt.datatransfer.MimeType)super.clone();
        } catch (CloneNotSupportedException cannotHappen) {
        }
        newObj.parameters = (eu.ocathain.awt.datatransfer.MimeTypeParameterList)parameters.clone();
        return newObj;
    }

    private String    primaryType;
    private String    subType;
    private eu.ocathain.awt.datatransfer.MimeTypeParameterList parameters;
