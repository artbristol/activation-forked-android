 ...
 * {@code "image/x-java-image;class=eu.ocathain.awt.Image"},
 * the primary type is {@code image}, the subtype is
 * {@code x-java-image}, and the representation class is
 * {@code eu.ocathain.awt.Image}. When {@code getTransferData} is invoked
 * with a {@code DataFlavor} of {@code imageFlavor}, an instance of
 * {@code eu.ocathain.awt.Image} is returned.
...
public class DataFlavor implements Externalizable, Cloneable {
     ...
     * </pre>
     */
    public static final DataFlavor imageFlavor = createConstant("image/x-java-image; class=eu.ocathain.awt.Image", "Image");
     ...
     * from an invocation <code>eu.ocathain.awt.datatransfer.getTransferData</code>.
     */
