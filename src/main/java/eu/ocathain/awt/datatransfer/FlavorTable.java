 ...
 * @since 1.4
 */
public interface FlavorTable extends eu.ocathain.awt.datatransfer.FlavorMap {
     ...
     */
    List<String> getNativesForFlavor(eu.ocathain.awt.datatransfer.DataFlavor flav);
